...
#    Updated: 2019/03/05 15:43:05 by brfeltz          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_memdel.c ft_putendl_fd.c ft_strequ.c ft_strmap.c ft_strnew.c ft_isalnum.c \
ft_memalloc.c ft_memmove.c ft_putnbr.c ft_strclr.c ft_striter.c ft_strmapi.c ft_strnstr.c ft_tolower.c ft_isalpha.c \
ft_memccpy.c ft_memset.c ft_putnbr_fd.c ft_strcmp.c ft_striteri.c ft_strncat.c \
ft_toupper.c ft_isspace.c ft_strchr.c ft_strjoin.c ft_strrchr.c ft_strtrim.c \
ft_strsplit.c ft_lstnew.c ft_lstdel.c ft_lstdelone.c ft_lstadd.c ft_lstiter.c ft_lstmap.c \
...
ft_memdel.o ft_putendl_fd.o ft_strequ.o ft_strmap.o ft_strnew.o ft_isalnum.o \
ft_memalloc.o ft_memmove.o ft_putnbr.o ft_strclr.o ft_striter.o ft_strmapi.o ft_strnstr.o ft_tolower.o ft_isalpha.o \
ft_memccpy.o ft_memset.o ft_putnbr_fd.o ft_strcmp.o ft_striteri.o ft_strncat.o \
ft_toupper.o ft_isspace.o ft_strchr.o ft_strjoin.o ft_strrchr.o ft_strtrim.o \
ft_strsplit.o ft_lstnew.o ft_lstdel.o ft_lstdelone.o ft_lstadd.o ft_lstiter.o ft_lstmap.o \
